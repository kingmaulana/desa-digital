...
try {
          ...
          return ResponseHelper::jsonResponse(true, 'Data pendaftar event berhasil Ditambahkan', new EventParticipantResource($eventParticipants), 200);
        } catch (\Exception $e) {
          return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
  ...
  public function show(string $id)
  {
      try {
          ...
          return ResponseHelper::jsonResponse(true, 'Data Pendaftar event berhasil diambil', new EventParticipantResource($event), 200);
        } catch (\Exception $e) {
          return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
  }
  ...
  public function update(EventParticipantUpdateRequest $request, string $id)
  {
    $request = $request->validated();
      try {
          ...
          $eventParticipants = $this->eventParticipantRepository->update($id, $request);

          return ResponseHelper::jsonResponse(true, 'Data Pendaftar event berhasil diupdate', new EventParticipantResource($eventParticipants), 200);
        } catch (\Exception $e) {
          return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
  }
