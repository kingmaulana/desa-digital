  ...
  public function __construct(DevelopmentApplicantRepositoryInterface $developmentApplicantRepository)
  {
    ...
    public function store(DevelopmentApplicantStoreRequest $request)
    {
        ...
        try {
          ...
          return ResponseHelper::jsonResponse(true, 'Data Pendaftar pembangunan berhasil Disimpan', new DevelopmentApplicantResource($developmentApplicant), 201);
        } catch (\Exception $e) {
          return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
         try {
          ...
          return ResponseHelper::jsonResponse(true, 'Data Pendaftar pembangunan berhasil Dihapus', null, 204);
        } catch (\Exception $e) {
          return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
        }
    }
