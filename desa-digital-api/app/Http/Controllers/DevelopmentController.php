...
class DevelopmentController extends Controller
{
  ...
  public function index(Request $request)
  {
    try {
      ...
      return ResponseHelper::jsonResponse(true, 'Data dedvelopment berhasil Diambil', DevelopmentResource::collection($developments), 200);
    } catch (\Exception $e) {
  ...
  public function getAllPaginated(Request $request)
  {
    ...
    try {
      ...
      return ResponseHelper::jsonResponse(true, 'Data development berhasil Diambil', PaginateResource::make($events, DevelopmentResource::class), 200);
    } catch (\Exception $e) {
      return ResponseHelper::jsonResponse(false, $e->getMessage(), null, 500);
    }
  }
